...
namespace SmartDose.WcfLib
{
    ...
    public class UpdateBuilder<TModel> : UpdateBuilder where TModel : class
    {
        ...
        #region Modelbuilder
        public UpdateBuilder<TModel> DebugInfoAll(bool debugInfoFlagAll)
        {
            ModelBuilder.DebugInfoAll(debugInfoFlagAll);
            return this;
        }
        public UpdateBuilder<TModel> DebugInfo(bool debugInfoFlag)
        {
            DebugInfoFlag = debugInfoFlag;
            return this;
        }

        public UpdateBuilder<TModel> TableOnly(bool tableOnlyFlag=true)
        {
        ...
        public async Task<IServiceResult> ExecuteAsync(Expression<Func<TModel, bool>> whereExpression = null)
        {
            ...
            return await Client.ExecModelUpdateAsync(this).ConfigureAwait(false);
        }
